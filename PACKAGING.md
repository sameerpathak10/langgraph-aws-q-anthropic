...
## Troubleshooting
- If you see ImportError at runtime, ensure the package directories are at the root of the ZIP (top-level modules should be present in the zip root).
- To test locally, run `python main.py --query "your test question"` (file includes a small CLI harness).